...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _components_form_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./components/form.js */ "./src/js/components/form.js");
/* harmony import */ var _components_dynamic_adapt_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./components/dynamic-adapt.js */ "./src/js/components/dynamic-adapt.js");
...
/* harmony import */ var _components_navigation_js__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./components/navigation.js */ "./src/js/components/navigation.js");
/* harmony import */ var _components_aos_js__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./components/aos.js */ "./src/js/components/aos.js");
/* harmony import */ var _components_count_js__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./components/count.js */ "./src/js/components/count.js");
/* harmony import */ var _components_achievements_slider_js__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./components/achievements-slider.js */ "./src/js/components/achievements-slider.js");
...
const focusContent = debounce(() => {
  ...
  if (id && id.length > 0) {
    ...
    if (active_section !== link) {
      if (id && document.querySelectorAll(`.navigation__item[href="#${id}"]`).length > 0) {
        document.querySelectorAll(`.navigation__item`).forEach(i => {
          i.classList.remove("active");
        });
        document.querySelectorAll(`.navigation__item[href="#${id}"]`).forEach(i => i.classList.add("active"));
      }
      active_section = link;
    }
  }
